...
#define GNAMES 0x17722E80
#define GOBJECTS 0x177FFDB0
...
#define WEAPON_DATA 0x5A0
#define bIsReloading 0x3A1

// ===== Timing =====
#define LAST_SUBMIT_TIME 0x328
#define LAST_SUBMIT_TIME_ON_SCREEN 0x330
